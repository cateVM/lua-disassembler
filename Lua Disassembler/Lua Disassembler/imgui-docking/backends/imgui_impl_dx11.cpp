...
#include "..\imgui.h"
#include "..\imgui_internal.h" // for IM_ASSERT_USER_ERROR
...
static void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport)
{
    ...
    IM_ASSERT(hwnd != 0);
    HANDLE hIcon = LoadImage(0, _T(ICON_NAME), IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);
    IM_ASSERT_USER_ERROR(hIcon != 0,"icon not found! please put the icon in the *same* directory as the executable");
